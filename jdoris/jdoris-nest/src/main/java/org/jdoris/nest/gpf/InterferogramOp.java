...
//        long maxPixel = masterMetadata.getCurrentWindow().pixhi;
        ...
        double masterMinPi4divLam = (-4 * Math.PI * org.jdoris.core.Constants.SOL) / masterMetadata.getRadarWavelength();
        double slaveMinPi4divLam = (-4 * Math.PI * org.jdoris.core.Constants.SOL) / slaveMetadata.getRadarWavelength();
        ...
        for (int i = 0; i < srpNumberPoints; ++i) {
            ...
            org.jdoris.core.Point xyzMaster = masterOrbit.lp2xyz(line, pixel, masterMetadata);
            org.jdoris.core.Point slaveTimeVector = slaveOrbit.xyz2t(xyzMaster, slaveMetadata);
