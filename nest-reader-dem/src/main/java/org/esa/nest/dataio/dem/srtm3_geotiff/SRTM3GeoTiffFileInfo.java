...
import org.esa.nest.dataio.dem.ace.ACEFileInfo;
 ...
 */
public class SRTM3GeoTiffFileInfo {
    ...
    public static SRTM3GeoTiffFileInfo create(final File file) throws IOException {
        return createFromDataFile(file);
    }

    private static SRTM3GeoTiffFileInfo createFromDataFile(final File dataFile) throws IOException {
        final SRTM3GeoTiffFileInfo fileInfo = new SRTM3GeoTiffFileInfo();
