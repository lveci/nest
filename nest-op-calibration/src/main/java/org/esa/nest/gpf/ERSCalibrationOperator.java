 ...
 */
@OperatorMetadata(alias="ERS-Calibration",
                  description = "Calibration for ERS 1 & 2 data products.")
public final class ERSCalibrationOperator extends Operator {
...
//   private void computeIncidenceAnglesLookAnglesRangeSpreadingLoss() {
    ...
    public static class Spi extends OperatorSpi {
        public Spi() {
            super(ERSCalibrationOperator.class);
        }
    }
}
