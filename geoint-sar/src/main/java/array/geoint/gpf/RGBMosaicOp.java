 ...
 * The Mosaic operator.
 */
@OperatorMetadata(alias = "RGBMosaic",
        category = "Geometry",
        description = "Mosaics two or more products based on their geo-codings.")
public class RGBMosaicOp extends Operator {
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(RGBMosaicOp.class);
            super.setOperatorUI(RGBMosaicOpUI.class);
        }
    }
}