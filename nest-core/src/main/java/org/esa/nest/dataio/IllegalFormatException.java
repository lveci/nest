...
public class IllegalFormatException extends Exception {
     ...
     */
    public IllegalFormatException(final String message, final long streamPos) {
        super(message);
     ...
     *                unknown.)
     */
    public IllegalFormatException(final String message, final long streamPos, final Throwable cause) {
        super(message, cause);
        _streamPos = streamPos;
    }
