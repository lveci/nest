 ...
 *
 */
public class RadarsatProductReader extends AbstractProductReader {

    private RadarsatProductDirectory _dataDir;
    ...
    protected Product readProductNodesImpl() throws IOException,
        ...
        try {
            _dataDir = new RadarsatProductDirectory(fileFromInput.getParentFile());
    ...
    protected void readBandRasterDataImpl(int sourceOffsetX, int sourceOffsetY, int sourceWidth, int sourceHeight,
        ...
        try {
            final RadarsatImageFile imageFile = _dataDir.getImageFile(destBand);
