 ...
 *
 */
public class JERSProductReader extends AbstractProductReader {

    private JERSProductDirectory _dataDir;
    ...
    protected Product readProductNodesImpl() throws IOException,
        ...
        try {
            _dataDir = new JERSProductDirectory(fileFromInput.getParentFile());
    ...
    protected void readBandRasterDataImpl(int sourceOffsetX, int sourceOffsetY, int sourceWidth, int sourceHeight,
        ...
        try {
            final JERSImageFile imageFile = _dataDir.getImageFile(destBand);
