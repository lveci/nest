...
class JERSLeaderFile {
    ...
    public JERSLeaderFile(final ImageInputStream leaderStream) throws IOException,
...
//        return PalsarConstants.MAP_PROJECTION_UNKNOWN;
 ...
 /*   public long getNominalPixelsPerLine_1A_1B1() throws IOException,
     ...
     * @throws org.esa.nest.dataio.ceos.IllegalCeosFormatException
     */
  ...
  /*  public double[][] getCorrectedTransformationCoeffs() throws IOException,
    ...
    public MetadataElement getMapProjectionMetadata() throws IOException,
      ...
      /*  addGeneralProjectionMetadata(projMetadata);
        ...
        if (usedProjection.equalsIgnoreCase(JERSConstants.MAP_PROJECTION_RAW)) {
            addRawProjectionMetadata(projMetadata);
        } else if (usedProjection.equalsIgnoreCase(JERSConstants.MAP_PROJECTION_UTM)) {
            addGeneralCorrectedMetadata(projMetadata);
            addUTMProjectionMetadata(projMetadata);
        } else if (usedProjection.equalsIgnoreCase(JERSConstants.MAP_PROJECTION_PS)) {
            addGeneralCorrectedMetadata(projMetadata);
