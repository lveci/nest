...
class RadarsatImageFile {
    ...
    public String getBandDescription() {
        return String.format(RadarsatConstants.BAND_DESCRIPTION_FORMAT_STRING, new Object[]{_imageNumber});
    }
    ...
    public float getSpectralWavelength() {
        ...
        switch (bandIndex) {
        case 1:
            return RadarsatConstants.WAVELENGTH_BAND_1;
        case 2:
            return RadarsatConstants.WAVELENGTH_BAND_2;
        case 3:
            return RadarsatConstants.WAVELENGTH_BAND_3;
        case 4:
            return RadarsatConstants.WAVELENGTH_BAND_4;
        default:
            return 0;
        }
    }
    ...
    public float getSpectralBandwidth() {
        ...
        switch (bandIndex) {
        case 1:
            return RadarsatConstants.BANDWIDTH_BAND_1;
        case 2:
            return RadarsatConstants.BANDWIDTH_BAND_2;
        case 3:
            return RadarsatConstants.BANDWIDTH_BAND_3;
        case 4:
            return RadarsatConstants.BANDWIDTH_BAND_4;
        default:
            return 0;
        }
    }
