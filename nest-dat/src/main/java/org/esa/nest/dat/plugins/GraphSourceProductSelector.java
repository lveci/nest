...
public class GraphSourceProductSelector {
    ...
    public GraphSourceProductSelector(AppContext appContext, SwingBindingContext binding) {
        this(appContext, binding, "Name:");
    }

    public GraphSourceProductSelector(AppContext appContext, SwingBindingContext binding, String labelText) {
        ...
        binding.bind(productNameComboBox, "file");
    }
