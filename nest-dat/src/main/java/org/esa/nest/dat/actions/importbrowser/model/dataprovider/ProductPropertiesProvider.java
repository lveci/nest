...
public class ProductPropertiesProvider implements DataProvider {
    ...
    private static final String[] PROPERTY_KEYS = new String[]{
            KEY_PRODUCT_TYPE,
            KEY_PRODUCT_SIZE,
            KEY_PRODUCT_IMAGE_SIZE,
            KEY_PRODUCT_PIXEL_SIZE,
    ...
    public void createData(final RepositoryEntry entry, final Repository repository) throws IOException {
        try {
            ...
            final String imageSizeString = product.getSceneRasterWidth() + " x " + product.getSceneRasterHeight();
    ...
    private class ProductPropertiesRenderer extends JTable implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(final JTable table,
            ...
            if (value instanceof PropertyMap) {
                ...
                final String imageSizeString = propertyMap.getPropertyString(KEY_PRODUCT_IMAGE_SIZE, null);
                final String pixelSizeString = propertyMap.getPropertyString(KEY_PRODUCT_PIXEL_SIZE, null);
