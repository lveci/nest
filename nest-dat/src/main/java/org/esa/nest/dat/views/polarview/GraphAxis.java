...
public class GraphAxis
{
    ...
    protected class XAxisGraphics extends AxisGraphics
    {
        ...
        protected XAxisGraphics()
        {
        }
    }

    protected class YAxisGraphics extends AxisGraphics
    {
    ...
    public static Font getFont(String propertyName, String defaultFont)
    {
    ...
    public void setDataRange(double minValue, double maxValue, Class dataType)
    {
        minData = minValue;
        maxData = maxValue;
        if(autoRange)
    ...
    public void setApproximateRange(double minValue, double maxValue)
    {
     ...
     public static double warmNumber(double value, boolean up)
    {
    ...
    public String valueToString(double v, int exponent)
    {
        if(exponent != 0)
        {
    ...
    private final int defaultTickCount = 3;
