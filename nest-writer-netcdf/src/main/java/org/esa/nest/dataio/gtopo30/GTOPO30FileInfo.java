...
public class GTOPO30FileInfo {
    ...
    public static GTOPO30FileInfo create(final File file) throws IOException {
        return createFromDataFile(file);
    }

    private static GTOPO30FileInfo createFromDataFile(final File dataFile) throws IOException {
        final GTOPO30FileInfo fileInfo = new GTOPO30FileInfo();
    ...
    public void setFromData(final String fileName, final long fileSize) throws IOException {
        ...
        _noDataValue = GTOPO30ElevationModelDescriptor.NO_DATA_VALUE;
    }
