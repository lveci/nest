...
@OperatorMetadata(alias="CoregistrationCorCorr",
                  category = "InSAR Prototypes",
                  description = "Experimental operator for Coarse Coregistration")
public class CoregistrationCorCorrOp extends Operator {
...
//                label="Coherence Value Tolerance")
     ...
     */
    public CoregistrationCorCorrOp() {
    }
...
//            targetProduct.setPreferredTileSize(512, 2048);
//            targetProduct.getPreferredTileSize().;
    ...
    private static void addGCPGrid(
        ...
        // [PM]: for debugging
        System.out.println("number_of_input_pins: " + numPins);
        System.out.println("n_float_of_pins: " + n);
        int pinCunter = 0;
        ...
        System.out.println("Number of counted pins: " + pinCunter);
        System.out.println("-------------------------------------");
    ...
    public void computeTileStack(Map<Band, Tile> targetTileMap, Rectangle targetRectangle, ProgressMonitor pm)
        ...
        try {
            ...
            for(Band targetBand : targetProduct.getBands()) {
                ...
                System.out.println("Processing band: " + slaveBand.getDisplayName());

                if(complexCoregistration) {
                    System.out.println("Calling complex coregistration:");
            ...
            System.out.println("I am finalizing: " + threadCounter.increment());
    ...
    private synchronized void computeSlaveGCPs(final Band slaveBand, final Band slaveBand2, final Band targetBand,
     ...
     try {
        ...
        System.out.println("------------------------------------------------------------");
        System.out.println("I am here and number of master GPCs is:" + numberOfMasterGCPs);
        System.out.println("I am here and name of the slave band is:" + " [i]:" + slaveBand.getDisplayName() + " [q]:" + slaveBand2.getDisplayName());
        System.out.println("------------------------------------------------------------");
...
//                            System.out.println("GCP(" + i + ") is invalid.");
    ...
    private boolean getCoarseSlaveGCPPosition(final Band slaveBand, final Band slaveBand2,
        ...
        try {
            ...
            System.out.println("Master window position [x,y]: " + mGCPPixelPos.getX() + "," + mGCPPixelPos.getY());
            System.out.println("Slave window position [x,y]: " + sGCPPixelPos.getX() + "," + sGCPPixelPos.getY());
...
//                        final double v2 = masterData2.getElemDoubleAt(index);
    ...
    private double[] getSlaveImagette(final Band slaveBand, final Band slaveBand2, final PixelPos gcpPixelPos)
        ...
        System.out.println("Slave Imagette Rectangle [x,y] + [w,h]: " + slaveImagetteRectangle.x + "," +
                slaveImagetteRectangle.y + "," + slaveImagetteRectangle.width + "," + slaveImagetteRectangle.height);
    ...
    private static double getInterpolatedSampleValue(final Tile slaveRaster, final ProductData slaveData,
        ...
        // here caching is used: not really working for large windows, triggers: Cannot construct DataBuffer?
        try {
    ...
    public static class Spi extends OperatorSpi {
        public Spi() {
            super(CoregistrationCorCorrOp.class);
//            super.setOperatorUI(CoregistrationUI.class);
        }
    }
