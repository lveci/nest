...
/**
 */
@OperatorMetadata(alias="Fine Correlation Coregistration", internal=true)
public class CoregistrationCorFineOp extends Operator {
	 ...
	 */
    public CoregistrationCorFineOp() {
    }
    ...
    public static class Spi extends OperatorSpi {
        public Spi() {
            super(CoregistrationCorFineOp.class);
        }
    }
}