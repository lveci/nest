...
@OperatorMetadata(alias="CoregistrationCorCorr2",
                  category = "InSAR Prototypes",
                  description = "Experimental operator for Coarse Coregistration (no threading)")
public class CoregistrationCorCorr2Op extends Operator {
...
//                label="Coherence Value Tolerance")
     ...
     */
    public CoregistrationCorCorr2Op() {
    }
    ...
    public void initialize() throws OperatorException {
        ...
        System.out.println("I am in a modified version of stack operator");
    ...
    public void computeTileStack(Map<Band, Tile> targetTileMap, Rectangle targetRectangle, ProgressMonitor pm)
        ...
        try {
            ...
            // here put synchronized counter? or just a counter
            pm.done();
            System.out.println("I am finalizing: " + tempCounter++);
    ...
    private void computeSlaveGCPs(final Band slaveBand, final Band slaveBand2, final Band targetBand,
     ...
     try {
        ...
        // it loops through the whole space of points, instead of looking the right ones?
    ...
    public static class Spi extends OperatorSpi {
        public Spi() {
            super(CoregistrationCorCorr2Op.class);
