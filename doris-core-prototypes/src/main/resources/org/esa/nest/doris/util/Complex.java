 ...
 *
 *   - JAVA does not offer complex numbers as primitive data types
 *   - Defining a Complex.java class has following disadvantages:
 *        1. Object creation costs
 *        2. Object access costs
 *        3. Awkward arithmetic expressions
 *        4. Math library problems
 */
...
public class Complex{
        ...
        private double real = 0.0D;         // Real part
        private double imag = 0.0D;         // Imaginary part

        // TODO: remove this representation, never used!
        private static char jori = 'j';     // i or j in a + j.b or a + i.b representation
                                            // default value = j
