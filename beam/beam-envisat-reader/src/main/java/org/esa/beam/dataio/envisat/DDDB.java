 ...
 * @version $Revision: 1.4 $ $Date: 2010-11-08 18:54:23 $
...
//        Debug.trace("DDDB: " + recordInfo.toString());
     ...
     * enumerated by the several <code>TYPE_</code>X constants in <code>org.esa.beam.framework.datamodel.ProductData</code>
     * interface.
     *
     * @param dataTypeName the data type name
     *
     * @return the data type ID as enumerated by the several <code>TYPE_</code>X constants in
     *         <code>org.esa.beam.framework.datamodel.ProductData</code> interface, can also be
     ...
     *                 <code>org.esa.beam.framework.datamodel.ProductData</code> interface.
     *
     * @return a data type name, never <code>null</code>. If the type is <code>org.esa.beam.framework.datamodel.ProductData.TYPE_UNKNOWN</code>
