/*
 * $Id: PlacemarkManagerButtons.java,v 1.1 2009-04-27 13:08:26 lveci Exp $
 *
...
public class PlacemarkManagerButtons extends JPanel {
    ...
    public PlacemarkManagerButtons(final PlacemarkManagerToolView view) {
        ...
        gridButton = createButton("icons/NewGrid24.gif");
        gridButton.setName("gridButton");
        gridButton.setToolTipText("Create a grid of " + placemarkLabel + "."); /*I18N*/
    ...
    void updateUIState(final boolean productSelected, final int numSelectedPins) {
