/*
 * $Id: ProductImportAction.java,v 1.1 2009-04-27 13:08:25 lveci Exp $
 *
...
public class ProductImportAction extends ExecCommand {
    ...
    public void configure(ConfigurationElement config) throws CoreException {
        ...
        Boolean configFilesFoldersBoolean = getConfigBoolean(config, "useFilesAndFolders");
        if (configFilesFoldersBoolean != null) {
            useFilesAndFolders = configFilesFoldersBoolean;
        }
