...
class InformationPanel extends TextPagePanel {
    ...
    protected String createText() {
        ...
        long size = product.getRawStorageSize() / (1024 * 1024);
        appendEntry(sb, "File size:", String.valueOf(size) , "Mb");

        return sb.toString();
    }

    private static void appendEntry(final StringBuffer sb, final String label, final String value,
                             final String unit) {
        sb.append(String.format("%1$-40s \t", label));
        sb.append(value);
