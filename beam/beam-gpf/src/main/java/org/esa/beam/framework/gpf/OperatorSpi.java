...
public abstract class OperatorSpi {
    ...
    /**
     * Operator SPIs should call this method to set the User Interface for the Operator
     * The UI may be used within a tabbed panel
     * @param opUIClass the class of the user interface for the Operator
     */
    protected void setOperatorUI(Class<? extends OperatorUI> opUIClass) {
        operatorUIClass = opUIClass;
    }

    /**
     * Creates an instance of the OperatorUI
     * If no UI is set in the Operator SPI then the DefaultUI will generate a UI
     * @return OperatorUI the user interface for the Operator
     * @throws OperatorException
     */
    public OperatorUI createOperatorUI() throws OperatorException {
        try {
            return operatorUIClass.newInstance();
