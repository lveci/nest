/*
 * $Id: AbstractBand_EnsureMinLengthArray_Test.java,v 1.2 2010-03-31 13:59:56 lveci Exp $
 *
...
public class AbstractBand_EnsureMinLengthArray_Test extends TestCase {
    ...
    public void testEnsureMinLengthArray_ArrayIsNull() {
        ...
        final float[] floats = AbstractBand.ensureMinLengthArray((float[]) null, 4);
        assertNotNull(floats);
        assertEquals(4, floats.length);

        final double[] doubles = AbstractBand.ensureMinLengthArray((double[]) null, 4);
    ...
    public void testEnsureMinLengthArray_LengthIsEqual() {
        ...
        final float[] floatsReturned = AbstractBand.ensureMinLengthArray(floatsGiven, 4);
        assertSame(floatsGiven, floatsReturned);

        final double[] doublesGiven = new double[4];
        final double[] doublesReturned = AbstractBand.ensureMinLengthArray(doublesGiven, 4);
